...
class CourseRepository(BaseRepository[Course]):
        ...
        return [
            {
                ...
                "avg_difficulty": round(float(row.avg_difficulty), 2) if row.avg_difficulty else None,
    ...
    async def get_detail_with_stats(self, course_id: int) -> dict | None:
        ...
        return {
            ...
            "avg_difficulty": round(float(stats.avg_difficulty), 2) if stats.avg_difficulty else None,
